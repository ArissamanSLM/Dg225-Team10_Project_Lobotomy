...
| - | ------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------- | ------------- | ------ |
| 1 | I want to Drag Cards as it intended so it not like a clicker game                                      | Card At Left side to use Support Cards and at monster to Attack       | 5             | 1      |
...
| 3 | Add a title screen and Do screen mange mangement                                                       | Starting title screen and then When interact change the scene         | 3             | 1-2    |
...
| #  | User Story                                                                                                  | Acceptance Criteria                                                                                                   | Estimate (SP) | Sprint |
| -- | ----------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- | ------------- | ------ |
| 1  | As a player, I want to see my remaining Hp/Sanity, so that I know how close I am to game over               | จำนวนชีวิตแสดงบนจอตลอดเวลา ลดลงทันทีที่โดนโจมตี                         | 2             | 1      |
| 2  | Upgrade shop after retry so that new game Has Easier life                                                   | Permamant buffs for Staring game                                                                                      | 6             | 2      |
| 3  | Low sanity / health make Screen change or effect much Scaier so that it make it scary and closer to Death   | Player screen get more darker when sanity low and have more red when player heath is low                              | 5             | 1-2    |
...
| 9  | As an artist, I want make many map variation, so it it wont look repetitive                               | More environment                                                                                                     | 2             | 2      |
| 10 | As an artist, I want many enemy variation, so it it wont look repetitive                                  | More enemy variation                                                                                                 | 2             | 2      |
| X  | [As a ..., I want ..., so that ...]                                                                         | [เงื่อนไขที่นับว่า Story นี้ "เสร็จจริง"]                                                | [SP]          | —     |

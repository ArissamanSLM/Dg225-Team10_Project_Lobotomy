...
| ------------------------------------------- | --------------- | -------------------------------------------------- | ------------------------------------------------------------------------------------------------ | ---------- | -------------------------------- |
| 0. Kickoff & Ideation                       | 0–3            | [16:00] – [19:00]                                 | รู้ theme, brainstorm, ล็อกคอนเซปต์ + core loop 1 บรรทัด                    | ✅         | 16:09                            |
| 1. Planning & Setup                         | 3–6            | [19:00] – [22:00]                                 | GDD one-pager, ตกลง pipeline, ตั้ง repo, แบ่งงาน                                  | ✅         | 16:30                            |
